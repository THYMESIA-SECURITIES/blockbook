...
import (
	...
	"github.com/THYMESIA-SECURITIES/blockbook/bchain"
	"github.com/THYMESIA-SECURITIES/blockbook/bchain/coins/btc"
	"github.com/THYMESIA-SECURITIES/blockbook/common"
)

// tnotesRPC is an interface to JSON-RPC bitcoind service
type tnotesRPC struct {
	*btc.BitcoinRPC
}
...
// NewtnotesRPC returns new tnotesRPC instance
func NewtnotesRPC(config json.RawMessage, pushHandler func(bchain.NotificationType)) (bchain.BlockChain, error) {
...
// Initialize initializes tnotesRPC instance
func (z *tnotesRPC) Initialize() error {
	...
	z.Parser = NewtnotesParser(params, z.ChainConfig)
...
func (z *tnotesRPC) GetChainInfo() (*bchain.ChainInfo, error) {
...
func (z *tnotesRPC) GetBlock(hash string, height uint32) (*bchain.Block, error) {
	var err error
	if hash == "" && height > 0 {
...
func (z *tnotesRPC) GetTransactionForMempool(txid string) (*bchain.Tx, error) {
	return z.GetTransaction(txid)
}

// GetMempoolEntry returns mempool data for given transaction
func (z *tnotesRPC) GetMempoolEntry(txid string) (*bchain.MempoolEntry, error) {
